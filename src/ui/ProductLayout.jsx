...
function ProductLayout() {
    ...
    const [isMobile, setIsMobile] = useState(window.innerWidth < 646);
    ...
    return (
       <div className="">
         {isMobile && (
            <button className="p-2 flex justify-self-start bg-transparent hover:border-0" onClick={() => setShowFilters(!showFilters)}>☰</button>
        )}
        <div className="grid grid-cols-4 relative  ">
            ...
            <div className="col-span-4 sm:col-span-3 ps-5">
                ...
                <p className="col-span-4 text-start sm:text-base text-xs  mb-5"> {resultLength} results listed </p>
